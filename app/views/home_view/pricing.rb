...
class HomeView::Pricing < ApplicationComponent
    ...
    def render_personal
        div do
            div(class: 'relative flex flex-col p-6 md:p-10 rounded-2xl space-y-6 overflow-hidden bg-background border') do
                # Plan info
    ...
    def render_teams
        div do
            div(class: 'relative flex flex-col p-6 md:p-10 rounded-2xl space-y-6 overflow-hidden bg-accent text-accent-foreground') do
                ...
                # Price
                div(class: 'relative p-6 md:p-10 rounded-2xl space-y-6 overflow-hidden bg-background border') do
                    div(class: 'flex items-center justify-center space-x-4') do
                        # Price
                        div(class: 'relative') do
