  ...
  def view_template
    div(class: "max-w-2xl mx-auto w-full py-10 space-y-10") do
      ...
      div(class: "space-y-4") do
        ...
        TypographyP { "PhlexUI is built on top of 3 core ingredients: " }
        TypographyList do
      ...
      div(class: "space-y-4") do
        TypographyH2 { "Why I built PhlexUI" }
        TypographyP do
      ...
      div(class: "space-y-4") do
        ...
        TypographyP { "I'd like to thank the following projects and people for helping me build PhlexUI" }
        TypographyList do
