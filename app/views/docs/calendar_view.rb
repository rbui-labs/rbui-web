...
class Docs::CalendarView < ApplicationView
  def template
    div(class: "max-w-2xl mx-auto w-full py-10 space-y-8") do
      ...
      render Docs::VisualCodeExample.new(title: 'Connect to input') do
      ...
      render Docs::VisualCodeExample.new(title: 'Format date', description: 'Format dates with date-fns') do
        div(class: 'space-y-4') do
