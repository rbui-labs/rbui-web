  ...
  def template
    div(class: "max-w-2xl mx-auto w-full py-10 space-y-10") do
      div(class: 'space-y-2') do
        render PhlexUI::Typography::H1.new { "Context Menu" }
        render PhlexUI::Typography::P.new { "Displays a menu to the user — such as a set of actions or functions — triggered by a right click." }
      end
