                    ...
                    div(class: 'pb-4') do
                        ...
                        div(class: 'grid grid-flow-row auto-rows-max text-sm') do
                            COMPONENTS.each do |component|
                                a(href: component[:path], class: 'group flex w-full items-center rounded-md border border-transparent px-2 py-1 hover:underline text-muted-foreground') { component[:name] }
                            end
                        end
                    end
                end
